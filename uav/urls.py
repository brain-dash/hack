...
#-------------------Api-----------------------------------------------------------#
    ...
    path('api/getСharacteristics', views.apiGetСharacteristics, name = 'apiGetСharacteristics'),
    path('api/changeСharacteristics', views.apiChangeСharacteristics, name = 'apiChangeСharacteristics'), 
