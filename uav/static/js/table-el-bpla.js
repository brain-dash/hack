class TableBpla extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // const exampleModal = this.shadowRoot.getElementById('editBPLA');
      ...
      // this.shadowRoot.querySelector(".table-bpla-el").addEventListener("click",(e) =>this.openView(e));



      /********* */
      const modal = this.shadowRoot.querySelector(".modal");
      const btn = this.shadowRoot.getElementById("openBplaModal");

      const btnClose = this.shadowRoot.querySelector(".btn-modal-close");

      var span = this.shadowRoot.querySelector(".btn-close");
            ...
            <div id="myModal" class="modal">
              ...
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  <button class="btn btn-primary btn-modal-close" >Добавить</button>
                </div>
              </div>
