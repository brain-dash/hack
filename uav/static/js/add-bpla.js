              ...
              <form class="modal-content" action="api/changeCharacteristics" method="post">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                      ...
                      <input type="text" class="form-control" id="bpla-mass" name="name">
                    </div>
                    <div class="mb-3">
                ...
                <div class="modal-footer">
                  <button class="btn btn-primary" data-bs-target="#addBPLA2" data-bs-toggle="modal" type="submit">Добавить</button>
                </div>
              </div>
            </form>
          </div>
