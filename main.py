...
def test_circles():
    ...
    test_coords4 = [[44.95557731402297, 37.29571805551145],
                    [44.9575579430322, 37.29936585977172],
                    [44.95746653090055, 37.30022416665648],
                    [44.95292621056532, 37.30790601327514],
                    [44.95155490177605, 37.30091081216429]]


    radius = 0.005
    path_initial = Path.from_list(coords=test_coords4)
    ...
    path_initial.optimize(path_initial, radius=radius, n=2, wetzel=True, coordinates=True)
    path_initial.remove_overlapping(radius, iterations=1)
    path_initial.remove_straight_lines()

    path_final = plan_path_sec(path_initial, 50)
